...
:setdrives
set "old_val=%scan_drives%"
set "scan_drives="
set /p scan_drives=Enter drive letters (comma-separated, e.g. C,D,E) [Current: %old_val%]:
if not defined scan_drives set "scan_drives=%old_val%"
goto mainmenu

:setminsize
set "old_val=%min_size_mb%"
set "min_size_mb="
set /p min_size_mb=Enter minimum file/folder size in MB [Current: %old_val%]:
if not defined min_size_mb set "min_size_mb=%old_val%"
goto mainmenu

:setlimit
set "old_val=%display_limit%"
set "display_limit="
set /p display_limit=Enter number of items to display [Current: %old_val%]:
if not defined display_limit set "display_limit=%old_val%"
goto mainmenu
